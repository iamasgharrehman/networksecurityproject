...
from networksecurity.entity.artifact_entity import DatanIngestionArtifact,DataValidationArtifact
...
class DataValidation:
    def __init__(self,data_ingestion_artifact:DatanIngestionArtifact,
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            status = self.validat_number_of_columns(train_dataframe)
            if not status:
                error_message = f"Train dataframe doesnot contain all columns"
            status=self.validat_number_of_columns(test_dataframe)
            if not status:
